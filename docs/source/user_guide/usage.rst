...
This documentation includes a :doc:`notebook example <../examples/example_module>` that shows how to use these classes. For a more detailed description of how to use these classes and other functions available in ``bowshockpy`` package, see the :doc:`API Reference <../api/index>`.
